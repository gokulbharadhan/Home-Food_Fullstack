...
const useStyles = makeStyles((theme) => {
  return {
    ...
    appBar: {
      ...
      background:"linear-gradient(to right, #226B80, #35B0AB)"
//DEBEE6
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          <h2 style={{color:"white",marginTop:"30px"}}>HOME FEAST</h2>
          </Typography>
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 ,mt:"17px"}}>
