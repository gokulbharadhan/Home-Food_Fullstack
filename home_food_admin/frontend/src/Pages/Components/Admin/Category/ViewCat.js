...
const ViewCat = () => {    
    ...
    return  (
        <div style={{marginTop:'5px', padding:'10px' ,height:'300px',width:'1050px'}}>
            <div className = "topContent">
                <Box sx={{ flexGrow: 1, padding:'10px' }}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={2}>
                            <Button style={{ marginTop:'5px', marginLeft: '10px', position: 'relative',  left: '-65px',background:'#226B80'}} onClick={(e) => {
                                setIsAddButton(true);
                                setOpen(true);
                                setEditData([]);
                            }} variant="contained"
